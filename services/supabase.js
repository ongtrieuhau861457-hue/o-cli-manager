...
async function apiCall(method, path, accessToken, data, logger, actionName) {
...
const actions = {
  listProjects: {
    ...
    async execute(profile, params, logger) {
      ...
      if (!token) {
        return { success: false, data: null, message: 'Thieu credentials.accessToken trong profile' };
      }
      try {
        ...
        return {
          success: true,
          data,
          message: `Tim thay ${count} project(s)`,
        };
      } catch (err) {
  ...
  createProject: {
    ...
    async execute(profile, params, logger) {
      ...
      if (missing.length > 0) {
        return { success: false, data: null, message: `Thieu params bat buoc: ${missing.join(', ')}` };
      }
  ...
  getProjectApiKeys: {
    ...
    async execute(profile, params, logger) {
      ...
      if (!params.project_ref) {
        return { success: false, data: null, message: 'Thieu param: project_ref' };
      }

      try {
        const data = await apiCall(
          'GET',
          `/projects/${params.project_ref}/api-keys`,
          token,
          null,
          logger,
          'getProjectApiKeys'
        ...
        return {
          success: true,
          data,
          message: `Lay duoc ${keyCount} API key(s) cho project ${params.project_ref}`,
        };
      } catch (err) {
        return { success: false, data: null, message: err.message };
      }
  ...
  pauseProject: {
    ...
    async execute(profile, params, logger) {
      ...
      try {
        const data = await apiCall(
          'POST',
          `/projects/${params.project_ref}/pause`,
          token,
          null,
          logger,
          'pauseProject'
        ...
        return {
          success: true,
          data,
          message: `Da gui lenh pause cho project ${params.project_ref}`,
        };
      } catch (err) {
        return { success: false, data: null, message: err.message };
      }
  ...
  restoreProject: {
    ...
    async execute(profile, params, logger) {
      ...
      try {
        const data = await apiCall(
          'POST',
          `/projects/${params.project_ref}/restore`,
          token,
          null,
          logger,
          'restoreProject'
        ...
        return {
          success: true,
          data,
          message: `Da gui lenh restore cho project ${params.project_ref}`,
        };
      } catch (err) {
        return { success: false, data: null, message: err.message };
      }
